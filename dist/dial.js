...
class Dial {
    constructor() {
        ...
        board_1.board().ready.then((board) => {
            this.upButton = new johnny_five_1.default.Button(40);
            this.downButton = new johnny_five_1.default.Button(38);
            this.pressButton = new johnny_five_1.default.Button(36);
